...
/**
 * 5. (3) Измените пример ListFeatures.java, чтобы вместо объектов Pet в нем использовались значения integer
 * (не забудьте про автоматическую упаковку!). Объясните различия в результатах.
 * <p>
...
public class ListFeaturesInt {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> pets = randomMetod(rand.nextInt(10));
        print("1: ", pets);
...
//            print("7: " + pets.remove(p));
        print("8: " + pets);
        pets.add(3, rand.nextInt(10)); // Insert at an index
        print("9: " + pets);
...
//            print("23: " + pa[3].id());
    ...
    private static List<Integer> randomMetod(int rand) {
    ...
    private static void print(String s, List<Integer> integerList) {
        System.out.print(s);
