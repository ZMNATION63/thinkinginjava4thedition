package com.company.chapter17containerdetails.examples.ex023listsortsearch;

import com.company.chapter17containerdetails.examples.ex022utilities.Utilities;
...
public class ListSortSearch {
    public static void main(String[] args) {
        ...
        // Использование ListIterator для отсечения последнихэлементов:
